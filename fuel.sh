...
mkdir $HOME/.fuel
cd $HOME/.fuel
wget -O chain_config.json https://github.com/FuelLabs/chain-configuration/raw/master/ignition-test/chain_config.json
wget -O metadata.json https://github.com/FuelLabs/chain-configuration/raw/master/ignition-test/metadata.json
wget -O state_config.json https://github.com/FuelLabs/chain-configuration/raw/master/ignition-test/state_config.json
wget -O state_transition_bytecode.wasm https://github.com/FuelLabs/chain-configuration/raw/master/ignition-test/state_transition_bytecode.wasm
